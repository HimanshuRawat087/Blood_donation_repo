defmodule BloodbankWeb.UserLiveTest do
  use BloodbankWeb.ConnCase

  import Phoenix.LiveViewTest
  import Bloodbank.AccountFixtures

  @create_attrs %{age: 42, blood_group: "some blood_group", contact_no: 42, name: "some name"}
  @update_attrs %{
    age: 43,
  ...
  @invalid_attrs %{age: nil, blood_group: nil, contact_no: nil, name: nil}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated blood_group"
    end
