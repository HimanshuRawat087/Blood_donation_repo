defmodule BloodbankWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BloodbankWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BloodbankWeb.Gettext, "errors", msg, opts)
    end
  end
